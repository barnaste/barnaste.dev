...
<svelte:head>
    ...
    <meta name="description" content="Computer Science Student at the Univerity of Toronto" />
    ...
    <div class="flex flex-row flex-wrap justify-between gap-y-8 items-center max-lg:justify-center">
        {#if visible}
            ...
            <div class="flex flex-col gap-y-6 w-85">
                <div class="flex flex-col gap-y-3" transition:stagger={{ delay: titleDelay }}>
                    ...
                    <div class="flex flex-row items-center">
                        ...
                        <div class="relative h-auto w-fit overflow-hidden group my-auto">
                            <span
                                class="block border-b-2 border-dashed border-olive-400 text-base text-olive-500 dark:text-olive-400 cursor-pointer transition-none"
                            >
                                <span
                                    class="block transition-transform duration-300 ease-in-out group-hover:-translate-y-full min-w-26"
                                >
                                    On Study Term
                                </span>
                                <span
                                    class="block absolute top-full transition-transform duration-300 ease-in-out group-hover:-translate-y-full"
                                >
                ...
                <!-- Contact Links -->
                <div class="mt-1 ml-4" transition:stagger={{ delay: contactDelay }}>
                    <ContactLinks />
                </div>

                <!-- Blurb -->
                <p
                    transition:stagger={{ delay: blurbDelay }}
                    class="text-olive-600 dark:text-olive-400"
                >
                    I'm a student at the University of Toronto studying Maths and Computer Science,
                    with a particular interest in theory and logic. I enjoy reading modern classics
                    and philosophy. At some point I'll end up writing about them here.
                </p>
            </div>
            ...
            <div class="flex flex-col gap-y-6 pt-2 w-70">
                ...
                <ul
                    ...
                    transition:stagger={{ delay: skillDelay }}
                >
                    <li class="skill-card">
                    ...
                    <li class="skill-card">
                        <iconify-icon icon="streamline-logos:c-language-logo-solid" width="24"
                        ></iconify-icon>
                ...
                <!-- Photo -->
                <div
                    class="rounded-sm bg-olive-100 dark:bg-olive-800 h-50 flex justify-center items-center
            max-lg:w-full max-lg:scale-115 max-lg:mt-10"
                    transition:stagger={{ delay: photoDelay }}
                >
