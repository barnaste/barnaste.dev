...
fn main() {
    // Print "Hello, world!" to the console using the println! macro.
    println!("Hello, world!");
    ...
    println!("The area of the rectangle is: {}", calculate_area(&my_rectangle));
}

// A simple function that takes a string slice and prints a greeting.
fn greet(name: &str) {
